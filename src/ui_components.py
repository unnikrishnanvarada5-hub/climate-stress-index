...
def _flatten(html: str) -> str:
    ...
    code block, so multi-line HTML built from indented f-strings/triple-
    quotes can accidentally render as literal text instead of HTML. This
    collapses all indentation so that never happens.
    """
...
def render_kpi_card(label: str, value: str, sub: str = "", accent: str = "#2DD4BF") -> str:
    html = f"""<div class="kpi-card" style="border-top: 2px solid {accent};">
